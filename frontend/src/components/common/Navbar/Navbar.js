      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <a className="navbar-brand" href="/">
            <span
              style={{ fontSize: "30px", fontWeight: "bold", color: "#009FBD" }}
            >
              GREEN<span style={{ color: "#E86A33" }}>MEDICINE</span>
            </span>
          </a>
          <button
...
const mapStateToProps = (state) => ({
  user: state.authReducer.user ? JSON.parse(state.authReducer.user) : null,
